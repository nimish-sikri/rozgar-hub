...
export const TwoFactorModal = ({
    ...
    const bodyContent = (
        <div className="flex flex-col">
            <div className="h-full rounded-lg w-full flex items-center justify-center">
            ...
            <div className="w-full flex flex-col">
                ...
                <p className="text-sm text-primary mt-2">Rozhar hub has support for two factor authentication that prevents unauthorised access</p>
            </div>
        </div>
    )
